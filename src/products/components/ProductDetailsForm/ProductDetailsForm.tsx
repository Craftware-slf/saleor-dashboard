...
export const ProductDetailsForm = ({
  ...
  // Note (FEAT-035): the "Fix formatting with AI" button moved off the product
  // description and onto the `specifications` attribute — see ReformatSpecsButton,
  // rendered next to the Attributes card on the product page.
