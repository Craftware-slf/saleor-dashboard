...
export default defineConfig(({ command, mode }) => {
  ...
  */
  const {
    ...
    SALEOR_APP_BC_URL,
    STOREFRONT_PREVIEW_URL_HJOL,
    STOREFRONT_PREVIEW_URL_GOLF,
    STOREFRONT_PREVIEW_URL_FIFA,
    SKIP_SOURCEMAPS,
    CUSTOM_VERSION,
    ...
    createHtmlPlugin({
      ...
      inject: {
        data: {
          ...
          SALEOR_APP_BC_URL: SALEOR_APP_BC_URL ?? "",
          STOREFRONT_PREVIEW_URL_HJOL: STOREFRONT_PREVIEW_URL_HJOL ?? "",
          STOREFRONT_PREVIEW_URL_GOLF: STOREFRONT_PREVIEW_URL_GOLF ?? "",
          STOREFRONT_PREVIEW_URL_FIFA: STOREFRONT_PREVIEW_URL_FIFA ?? "",
          IS_CLOUD_INSTANCE,
          LOCALE_CODE,
          POSTHOG_KEY,
          POSTHOG_EXCLUDED_DOMAINS,
